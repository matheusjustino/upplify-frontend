        ...
        const productItems = this.props.products.map((product: any) =>
            <div key={product.id} className="col-lg-3 col-md-3 col-sm-4">
                <div className="thumbnail text-center">
                    <a href={`#${product.id}`} onClick={(e:any) => this.props.handleAddToCart(e, product)}>
                    ...
                    <div>
                        ...
                        <button className="btn btn-success" onClick={(e:any) => this.props.handleAddToCart(e, product)}>Add</button>
                    </div>
                </div>
            </div>
        );
